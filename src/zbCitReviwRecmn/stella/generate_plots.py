...
pickle_file_path = 'loss_acc/5e_6_clip/loss_acc_3.pkl'  # Adjust this to your pickle file path

# Read the pickle file
with open(pickle_file_path, 'rb') as f:
    training_history = pickle.load(f)

# Extract loss and accuracy values from the list of tuples
loss_values = [item[1] for item in training_history]  # First element is loss
accuracy_values = [item[0] for item in training_history]  # Second element is accuracy
...
plt.tight_layout()
plt.savefig('plots_loss_acc/average_loss_ep2_5e_6_clip.png')
plt.close()
...
plt.tight_layout()
plt.savefig('plots_loss_acc/average_acc_ep2_5e_6_clip.png')
plt.close()
