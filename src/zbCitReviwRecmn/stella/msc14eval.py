...
def createIndex(main_data_,used_data,msc='',model_name_or_path='base'):
    ...
    model_name = 'base' if model_name_or_path=='base' else model_name_or_path.split("/")[-1]
...
def main_faiss(main_data, used_data, cross_features=False, subset='test', msc='', model_name_or_path='base'):
    ...
    for feature in cross_features:
        ...
        for batch_start in range(0, len(subset_df['document_id']), batch_size):
            ...
            #print(results)
            os.makedirs(f"data/{model_name}_{msc}/{used_data_str}_vs_{feature_str}/scores/{subset}/", exist_ok=True)
...
if __name__ == "__main__":
    ...
    createIndex(main_data_,'text',msc='14',model_name_or_path='/beegfs/schubotz/ankit/code/zbReviewCit/stella_emb/contra_stella/checkpoints/checkpoints_5e_6/checkpoint_epoch1.pt')
    main_faiss(main_data_,'text',msc='14',model_name_or_path='/beegfs/schubotz/ankit/code/zbReviewCit/stella_emb/contra_stella/checkpoints/checkpoints_5e_6/checkpoint_epoch1.pt')
    #print("next task")
