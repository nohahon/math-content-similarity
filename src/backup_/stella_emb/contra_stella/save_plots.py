...
print("Length of loss and accurracy values: ", len(loss_values), len(accuracy_values))
...
plt.xlabel('Stride (each stride is 20K steps)')
plt.ylabel('Average Loss')
plt.title('Average Loss per 20K steps')
plt.tight_layout()
plt.savefig('plots_loss_acc/5e_6/average_loss_5e_6_stride.png')
plt.close()
...
plt.title('Average Accuracy per 20K steps')
plt.tight_layout()
plt.savefig('plots_loss_acc/5e_6/average_acc_5e_6_stride.png')
plt.close()
