...
baseToke = "dunzhang/stella_en_400M_v5"
model_name = "trained_model_5e_6"
vector_dim = 1024
vector_linear_directory = f"2_Dense_{vector_dim}"
tokenizer = AutoTokenizer.from_pretrained(baseToke, trust_remote_code=True)
...
print("Testing model afer 1 epoch (all seeds) and hard loss function")
# Load the checkpoint for the model
#checkpoint_path = "noah/checkpoints/checkpoint_epoch33.pt"
