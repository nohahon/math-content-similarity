...
def svm_():
    ...
    test_probs = svm_clf.predict_proba(test_data)  # Getting the probability for label 1.0
    ...
    with open("svm_predictns.pkl", "wb") as wpf:
...
def getEvalScoresReRanker():
    ...
    """
    predictions_dir = "svm_predictns.pkl"
    ...
    with jsonlines.open('rslts_svm.jsonl', mode='w') as writer:
