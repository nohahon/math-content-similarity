...
def train_mart(train_file, val_file, test_file, embed_dir, processed_dir,
    ...
    #print("Lenght of training data and labels: ", len(training_data), len(labels))
    #print("Trainign data and labels 1: ", training_data[0], labels[0])
    #sys.exit(0)
    ...
    print("Original lables: ", len(labels))
    print("predcted labels: ", len(test_pred))
