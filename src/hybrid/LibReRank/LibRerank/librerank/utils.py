...
def construct_ranker_data(data):
    ...
    for i, d in enumerate(data):
        ...
        #    print("uid: ",uid,"profile: ",profile, "spar_ft: ",spar_ft,"dens_ft: ",dens_ft, "lb: ",lb)
    ...
    #sys.exit(0)
        #print(target_user, profiles, target_item_spar, target_item_dens, label, list_len)
